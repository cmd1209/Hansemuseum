...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/min/functions-min.js', array('jquery'), '1.0.0'); // Custom scripts
...
function html5blank_conditional_scripts()
{
    if (is_page('pagenamehere')) {
        wp_register_script('scriptname', get_template_directory_uri() . '/js/min/functions-min.js', array('jquery'), '1.0.0'); // Conditional script(s)
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'service-menu' => __('Service Menu', 'html5blank'), // Main Navigation
